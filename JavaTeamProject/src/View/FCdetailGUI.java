...
//		
//		JScrollPane scrollPane = new JScrollPane();
//		scrollPane.setBounds(12, 517, 320, -509);
//		frame.getContentPane().add(scrollPane);
//		
//		JPanel panel_1 = new JPanel();
//		panel_1.setBounds(12, 10, 320, 497);
...
//		
//		JLabel lb_fcname = new JLabel("<dynamic>");
//		lb_fcname.setFont(new Font("±º∏≤", Font.BOLD, 12));
//		panel_2.add(lb_fcname);
//		
//		JLabel lblNewLabel_5 = new JLabel("\uC2DC\uC124\uC124\uBA85");
//		lblNewLabel_5.setFont(new Font("±º∏≤", Font.BOLD, 12));
...
//		
//		JLabel lb_division = new JLabel((String) null);
...
//		panel_2_1.add(lb_1);
//		
//		JLabel lb_people = new JLabel((String) null);
...
//		
//		JLabel lb_homepage = new JLabel((String) null);
...
//		panel_3.setBounds(0, 0, 320, 497);
//		panel.add(panel_3);
//		
//		JButton btnNewButton = new JButton("\uC608\uC57D");
//		btnNewButton.addActionListener(new ActionListener() {
//			public void actionPerformed(ActionEvent e) {
//				Reservation_1updateGUI re1up= new Reservation_1updateGUI();
//			}
//		});
//		btnNewButton.setForeground(Color.WHITE);
//		btnNewButton.setFont(new Font("HY∞ﬂ∞ÌµÒ", Font.PLAIN, 12));
//		btnNewButton.setBackground(new Color(123, 104, 238));
//		btnNewButton.setBounds(275, 515, 57, 23);
//		frame.getContentPane().add(btnNewButton);
//	}
//}
