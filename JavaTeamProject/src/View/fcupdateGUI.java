...
>>>>>>> branch 'master' of https://github.com/2020-SMHRD-BIGDATA1/Public-Facilities-Reservation.git
	public fcupdateGUI(String name) {
		...
		lb_weekday.setText("ÆòÀÏ: " + con.getweekday(name));
		lb_weekend_1.setText("ÁÖ¸»: " + con.getweekend(name));
...
>>>>>>> branch 'master' of https://github.com/2020-SMHRD-BIGDATA1/Public-Facilities-Reservation.git
		...
		lblNewLabel.setFont(new Font("HY°ß¸íÁ¶", Font.PLAIN, 12));
...
//		};
// 
		String[] headings = new String[] { "»ç¿ëÀÚ ¾ÆÀÌµð", "ÆòÁ¡", "¸®ºä" };
...
//		String[] headings ={"»ç¿ëÀÚ ¾ÆÀÌµð", "ÆòÁ¡","¸®ºä"};
//		ArrayList<RatingVO> myarr= con.getrating(name);
