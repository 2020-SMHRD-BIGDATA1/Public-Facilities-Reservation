	...
	private void initialize() {
		...
		btnmdfy.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (cnt > 0) {
					JOptionPane.showMessageDialog(frame, "¼öÁ¤¼º°ø", "¼öÁ¤ °á°ú", JOptionPane.PLAIN_MESSAGE);
					frame.setVisible(false);
				} else {
					JOptionPane.showMessageDialog(frame, "¼öÁ¤½ÇÆÐ", "¼öÁ¤ °á°ú", JOptionPane.PLAIN_MESSAGE);
				}
